...
<?php 
	$dessert_id = $_GET['id'];
    try {
    $sql = "SELECT * FROM dessert WHERE id='$dessert_id'";
	...
	<div id="carte">
		...
		<div class="article-body">
			...
			<form action="" method="POST" accept-charset="utf-8">
				...
				<label id="contact_textmsg" for="contact_text">Desert Name</label><br />
				<input type="text" name="name" id="contact_name" size="30" class="hidevalue inputbox" 
				value="<?php echo htmlspecialchars($dessert_list['dessert_name']); ?>" /><br />
				
				<label id="contact_textmsg" for="contact_text">Description</label><br />
				<textarea cols="50" rows="10" name="detail" id="contact_text" ><?php echo htmlspecialchars($dessert_list['dessert_details']); ?></textarea><br />
				<input type="submit" name="edit_dessert" value="Edit dessert" class="button validate">
			...
			<?php 	
					...
					$dessert_name = $_POST['name'];
					$detail = $_POST['detail'];
					$dessert_id = $_GET['id'];
					$sql = "UPDATE dessert SET dessert_name='$dessert_name', dessert_details='$detail' WHERE id='$dessert_id'";
